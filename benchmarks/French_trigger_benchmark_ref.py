...
def French_trigger_policy(experiment_params, thresholds, activity_levels):


	result_policy = {
		"lockdown_heuristic":"French_trigger",
		"groups":groups,
		"experiment_params":{
...
def French_trigger_policy_fast(experiment_params, thresholds, activity_levels):
									...
									for act_H_t in lockdowns_to_try["high_activity"]:
										for act_L_t in lockdowns_to_try["low_activity"]:
												if act_L_t<act_H_t:
													...
													partial_result = French_trigger_policy_fast(experiment_params, thresholds, activity_levels)
													# other_result = French_trigger_policy(experiment_params, thresholds, activity_levels)
