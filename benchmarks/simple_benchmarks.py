...
def run_government_policy(experiment_params):
	...
	for t in range(simulation_params['time_periods']):
		...
		if t+start_day >= len(gov_policy):
			...
			del gov_policy[t+start_day]['date']
			del gov_policy[t+start_day]['days_from_lockdown']
...
def run_full_lockdown(experiment_params):
	...
	del ag_alpha["days_from_lockdown"]
	del ag_alpha["date"]
	...
	return run_constant_policy(experiment_params, alpha)
...
run_government_policy(experiment_params)
run_full_lockdown(experiment_params)
run_open(experiment_params)



# # Now we benchmark government full lockdown
# gov_lockdown_policy = gov_policy[0]
# del gov_lockdown_policy['date']
# del gov_lockdown_policy['days_from_lockdown']
# del gov_lockdown_policy['lockdown']
# alphas={ag:gov_lockdown_policy for ag in age_groups}
...
# alphas={ag:{
# 	"home": econ_params['upper_bounds']['home'],
# 	"leisure": 0.0,
# 	"other": 0.0,
# 	"school": 0.0,
# 	"transport": 0.0,
...
# alphas={ag:{
# 	"home": econ_params['upper_bounds']['home'],
# 	"leisure": econ_params['upper_bounds']['leisure'],
# 	"other": econ_params['upper_bounds']['other'],
# 	"school": econ_params['upper_bounds']['school'],
# 	"transport": econ_params['upper_bounds']['transport'],
# 	"work": econ_params['upper_bounds']['work']
# } for ag in age_groups}
