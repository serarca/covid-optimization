...
if groups == "all":
	...
	with open("../parameters/fitted-test.yaml") as file:
	...
	with open("../parameters/econ-zeroEconVal.yaml") as file:
...
def run_constant_policy(experiment_params, alpha):
	...
	dynModel.parameters['global-parameters']['C_mtest'] = 0
    
	dynModel.parameters['global-parameters']['C_atest'] = 0
