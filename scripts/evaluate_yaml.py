...
# heuristics = ["real/T-90","full_open/T-90","full_lockdown/T-90", "linearization_heuristic/T-90", "linearization_heuristic_Prop_Bouncing/T-90"]

# heuristics = ["real/T-30"]

heuristics = ["linearization_heuristic/T-30-lockdown_levels", "linearization_heuristic_Prop_Bouncing/T-30-lockdown_levels",  "linearization_heuristic/T-30_random_init", "linearization_heuristic_Prop_Bouncing/T-30_random_init"]
# heuristics = ["linearization_heuristic_Prop_Bouncing"]
...
for h in heuristics:
	for n in os.listdir("results/%s/"%h):
		if n[0:2] == "xi" and (".pdf" not in n):
			...
			if "linearization_heuristic" in h:
