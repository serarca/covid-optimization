...
class DynamicalModel:
	def __init__(self, parameters, econ_params, experiment_params, initialization, dt, time_steps, mixing_method, start_day, eta, transport_lb_work_fraction = 0 , extra_data = False):
		...
		self.groups = {}
		for n in self.parameters['seir-groups']:
			self.groups[n] = SEIR_group(self.parameters['seir-groups'][n], initialization[n], self.dt, self.mixing_method, self.time_steps, self)
